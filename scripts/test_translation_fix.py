        ...
        if model_data and model_data.get("model"):
            ...
            for test_case in test_cases:
                ...
                try:
                    ...
                    # Print the enhanced metrics fields
                    console.print(f"[bold cyan]Performance Metrics:[/bold cyan] {output.performance_metrics}")
                    console.print(f"[bold cyan]Memory Usage:[/bold cyan] {output.memory_usage}")
                    console.print(f"[bold cyan]Operation Cost:[/bold cyan] {output.operation_cost}")
                    console.print(f"[bold cyan]Accuracy Score:[/bold cyan] {output.accuracy_score}")
                    console.print(f"[bold cyan]Truth Score:[/bold cyan] {output.truth_score}")
